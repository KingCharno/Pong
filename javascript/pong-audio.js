...
export var wallSound = new soundFile("Sonar-ping-sound.mp3"); //load sound
soundArray.push(wallSound); //add sound to list of sounds

export var paddleSound = new soundFile("Deep Ocean Monster Noise.mp3");
soundArray.push(paddleSound);

export var scoreSound = new soundFile("Deep Ocean Monster Noise.mp3");
soundArray.push(scoreSound);

export var ambientSound = new soundFile("underwater-ambience.mp3");
